    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className="w-1/2 bg-white flex flex-col mx-auto">
                ...
                <div className="relative mb-4">
                    <label htmlFor="password" className="leading-7 text-sm text-gray-600">Teléfono</label>
                ...
                <input type="submit" value="registrar usuario" className='text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg uppercase'/>
